...
[void]$sb.AppendLine()
[void]$sb.AppendLine("Merge successes: **$successMerges** / $($repoJobs.Count). NuGet packages on GPR: **$($packages.Count)** · [org packages](https://github.com/orgs/$Org/packages) · [novolis-registry](https://github.com/$Org/novolis-registry).")
[void]$sb.AppendLine()
